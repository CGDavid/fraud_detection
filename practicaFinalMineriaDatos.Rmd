...
Y_pred <- predict(model, test, type = "response") %>% round()
...
La mejor combinación es k=2 y perc.over=5 con un F1_Score de 0,79. Este resultado es
...
Tomek solo está eliminando un 0.05% de elementos del dataset, por lo que no ayuda
